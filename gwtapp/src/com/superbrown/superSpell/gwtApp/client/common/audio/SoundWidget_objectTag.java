...
/**
 */
public class SoundWidget_objectTag extends SoundWidget
{
    public SoundWidget_objectTag(String uri, boolean visible, boolean startImmediately)
    {
        this(uri, visible, startImmediately, null);
    }

    public SoundWidget_objectTag(String uri, boolean visible, boolean startImmediately, String type)
    {
